...
public class ListenerBean {
	...
	public void proposalSave() {
		/*
		 * to check same car is not to allow insurance >>>unique
		 * key of car is chassic no and reg number
		 */
		boolean flag = vehicleService
				.serachVehicleByChassicNoAndRegNum(proposal);
		if (flag) {
			...
			System.out.println("user" + proposal.getpID());
	...
	public String getProposalForm() {
		proposal = new ProposalModel(); // new obj to save data
