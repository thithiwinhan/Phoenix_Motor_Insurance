...
public class AuthorizationFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws ServletException, IOException {    
        ...
        String loginURL = request.getContextPath() + "/templates/login.xhtml";
        String registerURL = request.getContextPath() + "/templates/register.xhtml";

        boolean loggedIn = (session != null) && (session.getAttribute("user") != null);
        boolean loginRequest = request.getRequestURI().equals(loginURL);
        boolean registerRequest = request.getRequestURI().equals(registerURL);
        boolean resourceRequest = request.getRequestURI().startsWith(request.getContextPath() + "/templates" + ResourceHandler.RESOURCE_IDENTIFIER);
