...
@Service
@Transactional
public class PolicyListingServiceImpl implements PolicyListingService {
		...
		@Override
		public List<ProposalModel> policyListing(User user) {
			...
			for (Proposal entity : proposalList) {
				System.out.println("------------------Enity Return Proposal List-----------");
		...
		@Override
		public List<ProposalModel> findPolicyById(int getpID) {
System.out.println("------------proposal Listing  search Dao -----------");
			...
			if (proposalList.isPresent()) {
				      ...
				      System.out.println("------------------Policy Enity Return List for search id-----------");
						ProposalModel model = new ProposalModel();
						
						System.out.println("---------------Policy Main Info  ------------");
						model.setpID(entity.getProposalId());
						model.setPremium(entity.getPremium());
						model.setSumInsure(entity.getSumInsure());
						model.setpID(entity.getProposalId());
